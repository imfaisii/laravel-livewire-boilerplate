...
final class RolesTable extends PowerGridComponent
{
    ...
    public function delete(Role $role)
    {
        ...
        self::toastSuccess('Role deleted successfully.');
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('id')
            ->addColumn('name')
            ->addColumn('created_at_formatted', fn (Role $model) => Carbon::parse($model->created_at)->diffForHumans())
    ...
    */
    ...
    {
        return [
            Button::add('action-btns')->bladeComponent('lv.powergrid.roles.action-btns', ['id' => 'id']),
        ];
    }
